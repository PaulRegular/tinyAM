...
```{r}
table_link(inputs$landings, table_name = "landings")
...
```{r}
table_link(inputs$catch.num, table_name = "catch_at_age")
...
rownames(mat) <- d$year
table_link(mat, table_name = "RV_index")
...
rownames(mat) <- d$year
table_link(mat, table_name = "SN_index")
...
table_link(d, table_name = "SS_index")
...
```{r}
table_link(inputs$SS_agecomps, table_name = "SS_age_composition")
...
mat <- d[, as.character(2:14)]
rownames(mat) <- d$year
table_link(mat, table_name = "weight_at_age")
...
mat <- d[, as.character(2:14)]
rownames(mat) <- d$year
table_link(mat, table_name = "maturity_at_age")
...
table_link(d, table_name = "tag_summary")
...
table_link(d, table_name = "catch_bounds")
...
rownames(m) <- ages
colnames(m) <- years
table_link(t(m), table_name = "baseline_m")
...
table_link(par_tab, table_name = "parameter_estimates")
...
table_link(par_tabs, table_name = "retro_parameter_estimates")
...
table_link(status_tab, table_name = "stock_size")
...
table_link(rate_tab, table_name = "rates")
...
table_link(t(N_matrix), table_name = "abundance_at_age")
...
table_link(t(ssa_matrix), table_name = "mature_abundance_at_age")
...
table_link(t(B_matrix), table_name = "biomass_at_age")
...
table_link(t(ssb_matrix), table_name = "mature_biomass_at_age")
...
table_link(t(pred_catch_wt_matrix) / 1000, table_name = "predicted_catch")
...
table_link(t(Z_matrix), table_name = "z_at_age")
...
table_link(t(M_matrix), table_name = "m_at_age")
...
table_link(t(F_matrix), table_name = "f_at_age")
