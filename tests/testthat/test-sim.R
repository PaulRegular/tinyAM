...
test_that("sim_tam: structure and labeling for samp_random = FALSE (obs-only)", {
  sims <- sim_tam(fit, n = 3, samp_fixed = TRUE, samp_random = FALSE,
...
test_that("sim_tam: schema is same for samp_random = TRUE, and values look sensible", {
  sims <- sim_tam(fit, n = 2, samp_fixed = TRUE, samp_random = TRUE,
                  progress = FALSE, seed = 1)
...
test_that("sim_tam: n controls the number of stacked simulations", {
  sims5 <- sim_tam(fit, n = 5, samp_fixed = TRUE, samp_random = FALSE,
                   progress = FALSE, seed = 1)
...
test_that("sim_tam works when projecting (is_proj propagated)", {
  ...
  proj_sim <- sim_tam(proj_fit, n = 5, samp_fixed = TRUE, samp_random = FALSE,
                      progress = FALSE, seed = 1)
...
test_that("sim_tam: seed makes results deterministic for a given mode", {
  # obs-only, fixed at MLEs (no parameter uncertainty)
  sims_a1 <- sim_tam(fit, n = 3, samp_fixed = FALSE, samp_random = FALSE,
                     progress = FALSE, seed = 42)
  sims_a2 <- sim_tam(fit, n = 3, samp_fixed = FALSE, samp_random = FALSE,
                     progress = FALSE, seed = 42)
  ...
  sims_b1 <- sim_tam(fit, n = 3, samp_fixed = TRUE, samp_random = TRUE,
                     progress = FALSE, seed = 99)
  sims_b2 <- sim_tam(fit, n = 3, samp_fixed = TRUE, samp_random = TRUE,
                     progress = FALSE, seed = 99)
